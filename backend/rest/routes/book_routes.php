...
Flight::group('/books', function () {
     ...
     *              @OA\Property(property="faculty", type="string", example="Some faculty", description="book faculty"),
     *              @OA\Property(property="department", type="string", example="Some department", description="book department"),
     *              @OA\Property(property="professor", type="string", example="Some professor", description="book professor"),
     *              @OA\Property(property="image", type="string", example="Some image", description="book image"),
     *          )
     *      )
     * )
     */
